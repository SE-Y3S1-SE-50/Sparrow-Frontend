            ...
            <div className="register-form-container">
              ...
              <form className="register-form">
                <div className="register-field">
                  ...
                  <input type="text" id="fullname" className="register-input" placeholder="Your full name" required />
                </div>
                <div className="register-field">
                  <label htmlFor="email">Email</label>
                  <input type="email" id="email" className="register-input" placeholder="you@example.com" required />
                </div>
                <div className="register-field">
